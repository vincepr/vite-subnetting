...
export default function Home(){
    return <div>
        ...
        <Link href="/converter/"><h3 style={{cursor: "pointer"}} >Binary-Hexa-Decimal</h3></Link>
        <label>Beliebiges umrechnung von Binär - Dezimal - Hexadezimal.</label>


        <Link href="/calculator-v4/"><h3 style={{cursor: "pointer"}}>Subnet-Calculator IPv4</h3></Link>
        <label>Berechnet Subnetze für Ipv4 Adressen.</label>


        <Link href="/calculator-v6/"><h3 style={{cursor: "pointer"}}>Subnet-Calculator IPv6</h3></Link>
        <label>Berechnet Subnetze für Ipv6 Adressen.</label>


        <Link href="/ip-game/"><h3 style={{cursor: "pointer"}}>Subnetting-Trainer</h3></Link>
